...
def play_model(cfg, player):
    ...
    while running:
        score = play_one_episode(player, predfunc, True)
        print("Total:", score)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', help='load model', default='AirRaid-v0.tfmodel')
    parser.add_argument('--env', help='env', default='everwing-v0')
